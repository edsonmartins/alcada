...
@RegisterForReflection(targets = {
        ...
        PessoasResource.Pessoa.class,
        PessoasResource.Problema.class,
        VozFeedbackResource.Req.class,
        VozFeedbackResource.Resp.class,
        VozFeedbackResource.Problema.class
})
